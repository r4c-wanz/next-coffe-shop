...
export default function Navbar() {
  return (
    <nav className="flex items-center justify-between px-11.5 py-9.5 text-xl font-semibold text-[#344E41]">
      ...
      <div className="flex items-center justify-between gap-7.5">
        ...
        <button className="relative w-13.5 h-13.5 rounded-lg cursor-pointer p-1">
          <ShoppingCartIcon size={40} className="absolute left-1 bottom-1" />
          <div className="absolute top-1 right-1 h-6.5 w-6.5 rounded-full bg-[#E68B24] text-white">
            2
          </div>
        </button>
      </div>
